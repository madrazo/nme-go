...
"   varying vec2 vTexCoord;
    ...
    void main() {  
        ...
        sum += texture2D(_RenderTexture, vec2(tc.x, tc.y - 4.0*blur)) * 0.05;
        sum += texture2D(_RenderTexture, vec2(tc.x, tc.y - 3.0*blur)) * 0.09;
        sum += texture2D(_RenderTexture, vec2(tc.x, tc.y - 2.0*blur)) * 0.12;
        sum += texture2D(_RenderTexture, vec2(tc.x, tc.y - 1.0*blur)) * 0.15;
        
        sum += texture2D(_RenderTexture, vec2(tc.x, tc.y)) * 0.16;
...
"   varying vec2 vTexCoord;
    ...
    void main() {  
        ...
        sum += texture2D(_RenderTexture, vec2(tc.x - 4.0*blur, tc.y)) * 0.05;
        sum += texture2D(_RenderTexture, vec2(tc.x - 3.0*blur, tc.y)) * 0.09;
        sum += texture2D(_RenderTexture, vec2(tc.x - 2.0*blur, tc.y)) * 0.12;
        sum += texture2D(_RenderTexture, vec2(tc.x - 1.0*blur, tc.y)) * 0.15;
