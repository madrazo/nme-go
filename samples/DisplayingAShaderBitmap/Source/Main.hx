...
class Main extends Sprite {
    ...
    public function new () {
        ...
        //Objects that use OGLView
        {
            ...
            colorSquare.x = ( (stage.stageWidth-50) / 2 ) -50;
            colorSquare.y = (stage.stageHeight-50) / 2 + 80;
            ...
            colorElephant.x = ( (stage.stageWidth-bitmapData.width) / 2 );
            colorElephant.y = (stage.stageHeight-bitmapData.height) / 2;
            ...
            bumpElephant.x = ( (stage.stageWidth-bitmapData.width) / 2) + 100;
            bumpElephant.y = (stage.stageHeight-bitmapData.height) / 2;
            ...
            bumpElephantDecal.x = ( (stage.stageWidth-bitmapData.width) / 2) + 250;
            bumpElephantDecal.y = (stage.stageHeight-bitmapData.height) / 2;
...
"   varying vec2 vTexCoord;
    ...
    void main() {           
        ...
        gl_FragColor = vec4( vec3( color, color * 0.1, sin( color + t / 9.0 ) * 0.75 ), 1.0 );
    }  
";
...
//Pixel shader with three textures
 ...
 "  varying vec2 vTexCoord;
    ...
    void main() {
        ...
        vec4 decal  = texture2D(_Texture2, vec2( vTexCoord.x, mod(vTexCoord.y+_Time.y*0.5,1.0) ) ).rgba;
...
"   varying vec2 vTexCoord;
    ...
    void main() {  
        ...
        float offset = _Time.y * 2.0 *3.14159 * 0.75;
